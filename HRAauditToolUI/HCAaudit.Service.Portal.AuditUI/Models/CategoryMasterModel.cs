...
namespace HCAaudit.Service.Portal.AuditUI.Models
{
    ...
    {
        public List<clstbHROCRoster> HROCRosterList { get; set; }
    }
    ...
    public class SubCategoryMastList
    {
        public List<SubCategoryMast> _subCategoryMastList { get; set; }
    }
    public class SubCategoryMast
    {
        public int CatgID { get; set; }
        public string CatgDescription { get; set; }
        public List<SubCategory> _subcategoryList { get; set; }
    }
