...
!(function (t, e) {
  ...
  var a = function (a, i, s) {
    if (
      ...
      (this.buttonClasses = "neu-button"),
      (this.applyButtonClasses = "neu-button--primary neu-button--raised "),
      (this.cancelButtonClasses = "neu-button--danger"),
      (this.locale = {
        direction: "ltr",
      ...
      "string" == typeof (i = e.extend(this.element.data(), i)).template ||
        ...
        (i.template =
          '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn neu-margin--right-10" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
      (this.parentEl =
