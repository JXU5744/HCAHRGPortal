#pragma checksum "C:\HCAProjects\HCAHRGPortal\HCAaudit.Service.Portal.AuditUI\Views\SubCategory\Details.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bcff0d8e39625d46ef4071225a47c74dad7d6d73"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bcff0d8e39625d46ef4071225a47c74dad7d6d73", @"/Views/SubCategory/Details.cshtml")]
    ...
    public class Views_SubCategory_Details : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<HCAaudit.Service.Portal.AuditUI.Models.CatSubCatJoinMast>>
    {
        ...
        {
#nullable restore
#line 1 "C:\HCAProjects\HCAHRGPortal\HCAaudit.Service.Portal.AuditUI\Views\SubCategory\Details.cshtml"
...
<div id=""popupcontent"" title=""Add Subcategory"" hidden=""hidden"" class=""container"">
    ...
    <div class=""row"">
        <div class=""col-sm-5"">
            <label for=""format-pdf"" class=""input-group"">Service Delivery Group:</label>
            <select name=""teams"" id=""ddlcategory"" class=""form-control"">
            </select>
            <span id=""errormsgcategory"" style=""color:red"">Select Service Delivery Group</span>
        </div>
        ");
            ...
            <input id=""txtsubcategory"" class=""form-control form-control-sm""
                   type=""text"" />
            <span id=""errormsgsubcategory"" style=""color:red"">Enter Subcategory</span>
        </div>
    ...
    <div class=""row"">
        ...
        <div class=""col-sm-6"">
            <button id=""btnaddSubCategory"" class=""btn btn-primary""> Save</button>&nbsp;
...
<div id=""popupcontentdelete"" title=""Delete Subcategory"" hidden=""hidden"" class=""container"">
    ...
    <br />
    <div class=""row"">
        <div class=""col-sm-4""><input id=""hdndeletecatid"" t");
            WriteLiteral(@"ype=""hidden"" /></div>
        <div class=""col-sm-2""></div>
        <div class=""col-sm-6"">
            <button id=""btnSubCatdelete"" class=""btn btn-primary""> Yes</button>&nbsp;
...
<script>
    ...
    $(document).ready(function() {
        $(""#example"").DataTable({
            ...
            ""columns"": [
                { ""data"": ""SubCatgID"", ""nam");
            WriteLiteral(@"e"": ""SubCatgID"", ""autoWidth"": true },
    ...
    $(function () {
        ...
        $(""#b");
            WriteLiteral(@"tncancelpopup"").click(function () {
    ...
    $(""#btnaddSubCategory"").click(function () {
        var catgID = $('#ddlcategory').val();
        var subCategoryName ");
            WriteLiteral(@"= $('#txtsubcategory').val();
    ...
    $(""#btnSubCatdelete"").click(function () {
        var url = '");
#nullable restore
#line 244 "C:\HCAProjects\HCAHRGPortal\HCAaudit.Service.Portal.AuditUI\Views\SubCategory\Details.cshtml"
              Write(Url.Content("~/"));
